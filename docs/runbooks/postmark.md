...
Every transactional email Selket sends: team invitations, email
...
1. **Sender Signatures** → add your domain (e.g. `selket.io`).
...
| `EMAIL_FROM` | recommended | Verified `From` address (default `notifications@selket.io`) |
