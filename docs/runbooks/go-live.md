...
The ordered checklist to take Vesta from "builds locally" to "a paying
...
- A **domain registrar** — for `vesta.io` (or your chosen domain).
...
fly secrets set \
  ...
  EMAIL_FROM="notifications@vesta.io" \
