"""Generate Selket_Sales_Deck.pptx — a 6-slide deck to send to a business
prospect. Ends with a sign-up CTA. Same Selket brand palette as the
...
def page_chrome(slide, eyebrow, title, slide_num, total):
    ...
    textbox(slide, Inches(0.6), Inches(7.05), Inches(6), Inches(0.3),
            'SELKET  ·  app.selket.io', size=9, color=ZINC_400)
...
textbox(s, Inches(0.9), Inches(6.46), Inches(5.2), Inches(0.55),
        '→  Start free at  app.selket.io/signup', size=14, bold=True,
...
textbox(s, Inches(0.9), Inches(6.21), Inches(7.0), Inches(0.7),
        '→  app.selket.io/signup', size=20, bold=True,
        color=BRAND_900, align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)

textbox(s, Inches(8.2), Inches(6.32), Inches(4.8), Inches(0.5),
        'Questions?  hello@selket.io', size=12, color=BRAND_100)


out = Path(__file__).parent / 'Selket_Sales_Deck.pptx'
prs.save(str(out))
print(f"Wrote {out}")
