...
// evidenceSigningKeys publishes the public halves of every key Dokaz signs
// or verifies evidence with, as a PEM document at a well-known path. A
// customer (or an auditor, or a court) holding a Dokaz-issued PDF can fetch
// this, pick the block whose PublicKeyID matches the signature, and verify
// the detached signature with stock OpenSSL — no Dokaz software in the loop.
